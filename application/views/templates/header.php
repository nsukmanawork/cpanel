        ...
        <form class="form-inline mr-auto">
          ...
          <div class="search-element">
            ...
            <!-- <div class="search-result">
              ...
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="<?php echo base_url('img/products/product-3-50.png') ?>" alt="product">
                  oPhone S9 Limited Edition
                </a>
              </div>
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="<?php echo base_url('img/products/product-2-50.png') ?>" alt="product">
                  Drone X2 New Gen-7
                </a>
              </div>
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="<?php echo base_url('img/products/product-1-50.png') ?>" alt="product">
                  Headphone Blitz
                </a>
              </div>
              <div class="search-header">
              ...
              <div class="dropdown-list-content dropdown-list-message">
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="<?php echo base_url('img/avatar/avatar-1.png') ?>" class="rounded-circle">
                ...
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="<?php echo base_url('img/avatar/avatar-2.png') ?>" class="rounded-circle">
                  </div>
                  <div class="dropdown-item-desc">
                    <b>Dedik Sugiharto</b>
                ...
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="<?php echo base_url('img/avatar/avatar-3.png') ?>" class="rounded-circle">
                    <div class="is-online"></div>
                  </div>
                  <div class="dropdown-item-desc">
                ...
                <a href="#" class="dropdown-item">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="<?php echo base_url('img/avatar/avatar-4.png') ?>" class="rounded-circle">
                  </div>
                  <div class="dropdown-item-desc">
                ...
                <a href="#" class="dropdown-item">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="<?php echo base_url('img/avatar/avatar-5.png') ?>" class="rounded-circle">
                  </div>
                  <div class="dropdown-item-desc">
                    <b>Alfa Zulkarnain</b>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?php echo site_url('/') ?>">Cpanel GPI Express</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?php echo site_url('/') ?>">GPI</a>
          </div>
            ...
            <li class="menu-header">Dashboard</li>
              <li class="nav-item dropdown active">
                ...
                <ul class="dropdown-menu">
                  <li id="menu_users"><a class="nav-link" href="<?php echo site_url('users') ?>">Users</a></li>
                  <li id="menu_projects"><a class="nav-link" href="<?php echo site_url('projects') ?>">Projects</a></li>
                  <li id="menu_services"><a class="nav-link" href="<?php echo site_url('services') ?>">Service</a></li>
